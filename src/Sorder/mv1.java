...
@SuppressWarnings("all") public class mv1 extends JFrame {
	...
	public mv1() {
		...
		JTextArea txtrLitwaksArcade = new JTextArea();
		txtrLitwaksArcade.setText("在他們第一次拯救 Litwak's Arcade 六年後，\nRalph 和 Vanellope 必須通過 Wi-Fi 路由器進\n入互聯網才能恢復遊戲。");
		txtrLitwaksArcade.setForeground(Color.LIGHT_GRAY);
		txtrLitwaksArcade.setFont(new Font("Lucida Grande", Font.PLAIN, 10));
		txtrLitwaksArcade.setEditable(false);
		txtrLitwaksArcade.setBackground(Color.BLACK);
		txtrLitwaksArcade.setBounds(182, 62, 212, 80);
		panel.add(txtrLitwaksArcade);
		
		JLabel lblNewLabel_2 = new JLabel("無敵破壞王 2\n");
		lblNewLabel_2.setForeground(Color.WHITE);
		lblNewLabel_2.setFont(new Font("Lucida Grande", Font.PLAIN, 20));
		lblNewLabel_2.setBounds(182, 18, 192, 26);
		...
		panel.add(label1);
		Image ad3 = new ImageIcon(this.getClass().getResource("/Pic/ad16.jpeg")).getImage();
		label1.setIcon(new ImageIcon(ad3));
