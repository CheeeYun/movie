...
@SuppressWarnings("all") public class mv5 extends JFrame {
	...
	public mv5() {
		...
		txtrbenedictCumberbatch.setText("這個更加陰鬱和嚴肅的叢林之書版\n本展示了一個在叢林中長大的小男\n孩的嚴酷生活。");
		...
		JLabel lblNewLabel_2 = new JLabel("無忌");
		...
		panel.add(label1);
		Image ad1 = new ImageIcon(this.getClass().getResource("/Pic/ad20.jpeg")).getImage();
